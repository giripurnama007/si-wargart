...
<div class="card">
    ...
    <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php elseif (in_array($surat['status'], ['Pending', 'Draft'])): ?>
        ...
        <?php if ($surat['status'] === 'Selesai' || ($surat['status'] === 'Pending' && hasRole(['admin', 'ketua_rt']))): ?>
            <hr>
            <h5>Aksi</h5>
